			...
			<div class="card">
				...
				<div class="card-body">
					<form action="install.php" method="post" id="SettingForm">
							...
							<div class="col-sm-10">
								<div class="form-check  form-check-inline">
									<input class="form-check-input" type="radio" name="DefaultLanguage"
										id="DefaultLanguage1" value="zh-CN" <?php if ($DefaultLanguage == "zh-CN")
											echo "checked"; ?>>
								...
								<div class="form-check  form-check-inline">
									<input class="form-check-input" type="radio" name="DefaultLanguage"
										id="DefaultLanguage2" value="en" <?php if ($DefaultLanguage == "en")
											echo "checked"; ?>>
									<label class="form-check-label" for="DefaultLanguage2">
										English (en)
									</label>
								</div>
								<small class="form-text">本项目目前支持 简体中文 和 English 两种语言，系统将会通过访客浏览器传入的 header
									信息进行判断。当无法判断访客使用的语言时，将会启用设置的默认语言。</small>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="form-check  form-check-inline">
									<input class="form-check-input" type="radio" name="IsCheckPassword"
										id="IsCheckPassword1" value="true" <?php if ($IsCheckPassword)
											echo "checked"; ?>>
								...
								<div class="form-check  form-check-inline">
									<input class="form-check-input" type="radio" name="IsCheckPassword"
										id="IsCheckPassword2" value="false" <?php if (!$IsCheckPassword)
											echo "checked"; ?>>
						...
						<div class="form-group row" id="Password" <?php if (!$IsCheckPassword)
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" name="DownloadLinkAvailableTime"
									value="<?php echo $DownloadLinkAvailableTime; ?>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" name="Cookie"
									placeholder="例：PANWEB=1; newlogin=1; BIDUPSID=326C4AD1E1521*********7151;……"
									value="<?php echo $Cookie; ?>">
								<small class="form-text">该参数也可以使用 SVIP 账号 Cookie</small>
								<small class="form-text">获取方法：使用 Edge/Chorme 浏览器 的 <b>无痕模式</b> 打开百度网盘网页版，按下 F12 打开开发者工具，选择
									网络 选项卡，刷新页面，找到一个 请求 URL 为 pan.baidu.com 开头的请求，在请求的详细信息页面往下滑找到 Cookie
									参数，右键复制值后粘贴到此处即可。</small>
								<small><a
										href="https://blog.imwcr.cn/2022/11/24/%e5%a6%82%e4%bd%95%e6%8a%93%e5%8c%85%e8%8e%b7%e5%8f%96%e7%99%be%e5%ba%a6%e7%bd%91%e7%9b%98%e7%bd%91%e9%a1%b5%e7%89%88%e5%ae%8c%e6%95%b4-cookie/">图文教程</a></small>
								<small class="form-text">获取 Cookie 后请勿退出登录，否则 Cookie 会失效。</small>
							</div>
						</div>
						<p>为防止概念混乱，自2.2.7版本起，删除普通账号 BDUSS 和 STOKEN 配置；普通账号设置上方完整 Cookie；将 SVIP 账号的 BDUSS 和 STOKEN 设置到下方即可。
						</p>
						<p>获取会员账号的 BDUSS 和 STOKEN 方法见 <a
								href="https://pandownload.net/faq/cookie.html">伪PD</a>（无需拼接，将对应的两个参数填入下方即可）</p>
						<!-- PD官网图炸了，换成伪PD的 -->
						<br />
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" name="SVIP_BDUSS"
									placeholder="例：W4tanVHelU2VGpxb**********0ZTZlUm1saEVtYnpTWjByfmxheWwxRFRtNlphQVFBQUFBJCQAAAAAAAAAAA……"
									value="<?php echo $SVIP_BDUSS; ?>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" name="SVIP_STOKEN"
									placeholder="例：0c27e6ebdb50252b**********a8b44f4ba448d0d62bc0527eead328d491a613"
									value="<?php echo $SVIP_STOKEN; ?>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="form-check  form-check-inline">
									<input class="form-check-input" type="radio" name="USING_DB" id="USING_DB1" value="true"
										<?php if ($USING_DB)
											echo "checked"; ?>>
								...
								<div class="form-check  form-check-inline">
									<input class="form-check-input" type="radio" name="USING_DB" id="USING_DB2"
										value="false" <?php if (!$USING_DB)
											echo "checked"; ?>>
						...
						<div id="DbConfig" <?php if (!$USING_DB)
							echo "style=\"display: none;\""; ?>>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<select class="form-control" name="DbConfig_dbtype">
										...
										<option value="sqlite" <?php if ($dbtype === "sqlite")
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control" name="DbConfig_servername"
										value="<?php echo $servername; ?>">
									<small class="form-text">填入MySQL数据库的地址或Sqlite数据库路径。</small>
								</div>
							</div>
							<div class="form-group row" id="username-field" <?php if ($dbtype === "sqlite")
								echo "style=\"display: none;\""; ?>>
							...
							<div class="form-group row" id="password-field" <?php if ($dbtype === "sqlite")
								echo "style=\"display: none;\""; ?>>
								<label class="col-sm-2 col-form-label">数据库密码</label>
								<div class="col-sm-10">
									<input class="form-control" name="DbConfig_DBPassword"
										value="<?php echo $DBPassword; ?>">
								</div>
							</div>
							<div class="form-group row" id="dbname-field" <?php if ($dbtype === "sqlite")
								echo "style=\"display: none;\""; ?>>
							...
							<div class="form-group form-check">
								<input type="checkbox" class="form-check-input" id="ReserveDBData" name="ReserveDBData"
									value="true">
